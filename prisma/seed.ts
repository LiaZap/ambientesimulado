...
async function main() {
    ...
    const questionsData = [
        ...
        { q: 12, s: 'PORTUGUES', t: 'Coesão', supportText: textPortugues, txt: 'No segundo parágrafo, a expressão "Dessa forma" estabelece relação de consequência com o período anterior.', ans: 'CERTO' },
        { q: 13, s: 'PORTUGUES', t: 'Verbos', supportText: textPortugues, txt: 'A locução verbal "tem se mostrado" poderia ser reescrita como tem-se mostrado, sem prejuízo da correção gramatical.', ans: 'CERTO' },
        { q: 14, s: 'PORTUGUES', t: 'Sintaxe', supportText: textPortugues, txt: 'No trecho "permitem a identificação de rotas", o sujeito da forma verbal "permitem" é composto.', ans: 'CERTO' },
        { q: 15, s: 'PORTUGUES', t: 'Semântica', supportText: textPortugues, txt: 'A expressão "atenção redobrada", no terceiro parágrafo, significa atenção duplicada ou intensificada.', ans: 'CERTO' },
        { q: 16, s: 'PORTUGUES', t: 'Concordância', supportText: textPortugues, txt: 'A substituição de "potencializa" por potencializam manteria a correção gramatical do período.', ans: 'ERRADO' },
        { q: 17, s: 'PORTUGUES', t: 'Conjunções', supportText: textPortugues, txt: 'O vocábulo "Apesar", que inicia o último parágrafo, poderia ser substituído por Embora, desde que feitos os ajustes necessários no restante do período.', ans: 'CERTO' },
        { q: 18, s: 'PORTUGUES', t: 'Crase', supportText: textPortugues, txt: 'No trecho "exige constante atualização das técnicas", o acento indicativo de crase seria facultativo caso se escrevesse "à constante atualização".', ans: 'ERRADO' },
        { q: 19, s: 'PORTUGUES', t: 'Semântica', supportText: textPortugues, txt: 'O termo "imperativos", no último período do texto, tem sentido de obrigatórios ou indispensáveis.', ans: 'CERTO' },
        { q: 20, s: 'PORTUGUES', t: 'Interpretação', supportText: textPortugues, txt: 'Depreende-se do texto que o combate ao narcotráfico nas rodovias federais depende exclusivamente do trabalho da PRF.', ans: 'ERRADO' },
