...
export async function updateSystemConfig(data: { n8nWebhookUrl?: string, n8nAssistantWebhookUrl?: string, n8nPlanningWebhookUrl?: string, landingPageVideoUrl?: string, facebookPixelId?: string, siteName?: string, maintenanceMode?: boolean, xpPerLesson?: number, xpBaseExam?: number }) {
    try {
        await requireAdmin()
